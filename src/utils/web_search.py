...
# search_nutrition_info 함수 추가 (workflow.py 호환용)
def search_nutrition_info(query: str, max_results: int = 3) -> str:
    """
    영양 정보 검색 (workflow.py 호환용)
    search_for_nutrition_info의 별칭
    """
    return search_for_nutrition_info(query, max_results)
